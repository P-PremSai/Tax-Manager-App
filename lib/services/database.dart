...
class DatabaseService {
  ...
  final CollectionReference OldTax =
      FirebaseFirestore.instance.collection('Old Tax');

  final CollectionReference NewTax =
      FirebaseFirestore.instance.collection('New Tax');
  ...
  Future<void> updateUserDataOldTax(var OldTaxes) async {
    return await OldTax.doc(uid).set({
      'Old Tax ': OldTaxes,
    });
  }

  Future<void> updateUserDataNewTax(var NewTaxes) async {
    return await NewTax.doc(uid).set({
      'New Tax ': NewTaxes,
    });
  }
